...
export class DocumentToArticleAssociations extends BaseEntity {
   ...
   */
  async create(
    documentToArticleAssociations: IDocumentToArticleAssociations
  ): Promise<ApiResponse<IDocumentToArticleAssociations>> {
   ...
   */
  async list(
    query: IDocumentToArticleAssociationsQuery = {}
  ): Promise<ApiResponse<IDocumentToArticleAssociations[]>> {
