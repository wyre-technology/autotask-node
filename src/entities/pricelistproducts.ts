...
export class PriceListProducts extends BaseEntity {
   ...
   */
  async create(
    priceListProducts: IPriceListProducts
  ...
  async update(
    ...
    return this.executeRequest(
      async () => this.axios.put(this.endpoint, priceListProducts),
      this.endpoint,
      'PUT'
    );
  }
  ...
  async patch(
    ...
    return this.executeRequest(
      async () =>
        this.axios.patch(this.endpoint, { ...(priceListProducts as any), id }),
      this.endpoint,
      'PATCH'
    );
  }
