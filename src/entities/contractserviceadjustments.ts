...
export class ContractServiceAdjustments extends BaseEntity {
   ...
   */
  async create(
    contractServiceAdjustments: IContractServiceAdjustments
  ...
  async update(
    ...
    return this.executeRequest(
      async () => this.axios.put(this.endpoint, contractServiceAdjustments),
      this.endpoint,
      'PUT'
    );
  }
    ...
    return this.executeRequest(
      async () =>
        this.axios.patch(this.endpoint, {
          ...(contractServiceAdjustments as any),
          id,
        }),
      this.endpoint,
      'PATCH'
   ...
   */
  async list(
    query: IContractServiceAdjustmentsQuery = {}
  ): Promise<ApiResponse<IContractServiceAdjustments[]>> {
