...
export class ContractServices extends BaseEntity {
   ...
   */
  async create(
    contractServices: IContractServices
  ...
  async update(
    ...
    return this.executeRequest(
      async () => this.axios.put(this.endpoint, contractServices),
      this.endpoint,
      'PUT'
    );
  }
  ...
  async patch(
    ...
    return this.executeRequest(
      async () =>
        this.axios.patch(this.endpoint, { ...(contractServices as any), id }),
      this.endpoint,
      'PATCH'
    );
  }
