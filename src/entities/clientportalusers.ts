...
export class ClientPortalUsers extends BaseEntity {
   ...
   */
  async create(
    clientPortalUsers: IClientPortalUsers
  ...
  async update(
    ...
    return this.executeRequest(
      async () => this.axios.put(this.endpoint, clientPortalUsers),
      this.endpoint,
      'PUT'
    );
  }
  ...
  async patch(
    ...
    return this.executeRequest(
      async () =>
        this.axios.patch(this.endpoint, { ...(clientPortalUsers as any), id }),
      this.endpoint,
      'PATCH'
    );
  }
