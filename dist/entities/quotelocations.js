...
class QuoteLocations extends base_1.BaseEntity {
    ...
    async update(id, quoteLocations) {
        ...
        return this.executeRequest(async () => this.axios.put(this.endpoint, quoteLocations), this.endpoint, 'PUT');
    }
    /**
    ...
    async patch(id, quoteLocations) {
        ...
        return this.executeRequest(async () => this.axios.patch(this.endpoint, { ...quoteLocations, id }), this.endpoint, 'PATCH');
    }
    /**
