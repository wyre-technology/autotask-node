...
class PurchaseApprovals extends base_1.BaseEntity {
    ...
    async update(id, purchaseApprovals) {
        ...
        return this.executeRequest(async () => this.axios.put(this.endpoint, purchaseApprovals), this.endpoint, 'PUT');
    }
    /**
    ...
    async patch(id, purchaseApprovals) {
        ...
        return this.executeRequest(async () => this.axios.patch(this.endpoint, { ...purchaseApprovals, id }), this.endpoint, 'PATCH');
    }
    /**
