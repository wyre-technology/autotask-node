...
class Tasks extends base_1.BaseEntity {
    ...
    async update(id, tasks) {
        ...
        return this.executeRequest(async () => this.axios.put(this.endpoint, tasks), this.endpoint, 'PUT');
    }
    /**
    ...
    async patch(id, tasks) {
        ...
        return this.executeRequest(async () => this.axios.patch(this.endpoint, { ...tasks, id }), this.endpoint, 'PATCH');
    }
    /**
     * Delete a tasks
