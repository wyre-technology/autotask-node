...
class Tickets extends base_1.BaseEntity {
    ...
    async update(id, tickets) {
        ...
        return this.executeRequest(async () => this.axios.put(this.endpoint, tickets), this.endpoint, 'PUT');
    }
    /**
    ...
    async patch(id, tickets) {
        ...
        return this.executeRequest(async () => this.axios.patch(this.endpoint, { ...tickets, id }), this.endpoint, 'PATCH');
    }
    /**
     * Delete a tickets
