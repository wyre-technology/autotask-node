...
class PriceListRoles extends base_1.BaseEntity {
    ...
    async update(id, priceListRoles) {
        ...
        return this.executeRequest(async () => this.axios.put(this.endpoint, priceListRoles), this.endpoint, 'PUT');
    }
    /**
    ...
    async patch(id, priceListRoles) {
        ...
        return this.executeRequest(async () => this.axios.patch(this.endpoint, { ...priceListRoles, id }), this.endpoint, 'PATCH');
    }
    /**
