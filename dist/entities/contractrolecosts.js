...
class ContractRoleCosts extends base_1.BaseEntity {
    ...
    async update(id, contractRoleCosts) {
        ...
        return this.executeRequest(async () => this.axios.put(this.endpoint, contractRoleCosts), this.endpoint, 'PUT');
    }
    /**
    ...
    async patch(id, contractRoleCosts) {
        ...
        return this.executeRequest(async () => this.axios.patch(this.endpoint, { ...contractRoleCosts, id }), this.endpoint, 'PATCH');
    }
    /**
