...
class ContactGroups extends base_1.BaseEntity {
    ...
    async update(id, contactGroups) {
        ...
        return this.executeRequest(async () => this.axios.put(this.endpoint, contactGroups), this.endpoint, 'PUT');
    }
    /**
    ...
    async patch(id, contactGroups) {
        ...
        return this.executeRequest(async () => this.axios.patch(this.endpoint, { ...contactGroups, id }), this.endpoint, 'PATCH');
    }
    /**
