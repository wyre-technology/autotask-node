...
class InventoryProducts extends base_1.BaseEntity {
    ...
    async update(id, inventoryProducts) {
        ...
        return this.executeRequest(async () => this.axios.put(this.endpoint, inventoryProducts), this.endpoint, 'PUT');
    }
    /**
    ...
    async patch(id, inventoryProducts) {
        ...
        return this.executeRequest(async () => this.axios.patch(this.endpoint, { ...inventoryProducts, id }), this.endpoint, 'PATCH');
    }
    /**
