...
class ClientPortalUsers extends base_1.BaseEntity {
    ...
    async update(id, clientPortalUsers) {
        ...
        return this.executeRequest(async () => this.axios.put(this.endpoint, clientPortalUsers), this.endpoint, 'PUT');
    }
    /**
    ...
    async patch(id, clientPortalUsers) {
        ...
        return this.executeRequest(async () => this.axios.patch(this.endpoint, { ...clientPortalUsers, id }), this.endpoint, 'PATCH');
    }
    /**
