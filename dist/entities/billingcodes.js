...
class BillingCodes extends base_1.BaseEntity {
    ...
    async update(id, billingCodes) {
        ...
        return this.executeRequest(async () => this.axios.put(this.endpoint, billingCodes), this.endpoint, 'PUT');
    }
    /**
    ...
    async patch(id, billingCodes) {
        ...
        return this.executeRequest(async () => this.axios.patch(this.endpoint, { ...billingCodes, id }), this.endpoint, 'PATCH');
    }
    /**
